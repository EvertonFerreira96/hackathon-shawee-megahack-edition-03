...
const Offline = ({search}) => {
  const categories = [
    { id: '01', starts: [1, 1, 1, 0, 0], autor: 'Everton Ferreira', offline: 0, indication:0, audioBook: 1, title: 'A arte do romance', img: livroArteDoRomance },
    { id: '02', starts: [1, 1, 1, 0, 0], autor: 'Everton Ferreira', offline: 0, indication:0, audioBook: 0, title: 'Conte aqui que eu canto lá', img: livroConteAquiQueEuContoLa },
    ...
    { id: '05', starts: [1, 1, 1, 0, 0], autor: 'Everton Ferreira', offline: 1, indication:0, audioBook: 0, title: 'Ninaua', img: livroNinaua },
  ...
  return (
      <FlatList
        ...
        renderItem={({item: project}) => 
          ...
          project.title.includes(search) && project.indication === 1 ? 
